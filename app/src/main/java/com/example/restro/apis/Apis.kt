...
import com.example.restro.utils.ConstantsValues.Companion.API_COMPANY_INFO
...
import com.example.restro.utils.ConstantsValues.Companion.API_UPDATE_RESERVATION_STATUS
...
interface Apis {
    ...
    @GET(API_COMPANY_INFO)
    suspend fun getCompanyInfo(): Response<ApiWrapper<ResponseV2<Company>>>

    @PUT(API_UPDATE_RESERVATION_STATUS)
    suspend fun updateReservationStatus(
        @Path("reservationId") reservationId: String,
        @Body reservationStatusRequest: ReservationStatusRequest
